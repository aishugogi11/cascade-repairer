...
Section 1: Core Acronyms & Industry Metrics
...
Cascaded Stack (The "Sandwich"): A traditional voice pipeline linking separate models in a sequence (STT → LLM → TTS). While easy to debug, it typically suffers from high latency (1–3s) and loses emotional nuance.
...
Section 3: Conversational UX & Dynamics
